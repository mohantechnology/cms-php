    ...
    for ($i = 0; $i < $no_of_file; $i++) {
        ...
        if ($sub == "0" || $unit == "0" || $cat == "0") {
            ...
            if (isset($file_extension_arr[$exten])) {
                ...
                // ensure topic table exists
                $table_name = "topic";
                $sql = "CREATE TABLE IF NOT EXISTS `$table_name` ( topic_name varchar(100) , unit varchar(10))";
                $result = $conn->query($sql);

                // ensure subject+unit table exists
                $table_name = $sub . $unit;
                $sql = "CREATE TABLE IF NOT EXISTS `$table_name` ( cat varchar(100) , path_name varchar(300), text_content MEDIUMTEXT)";
                $result = $conn->query($sql);
            ...
            <form id="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div id="message" class="box" <?php
                    ...
                    <div id="button_box">
                        ...
                        <a href='./displayfeedback.php' >  <button id="feedback_but" type="button"     > Feedback</button> </a> 
                    </div>
